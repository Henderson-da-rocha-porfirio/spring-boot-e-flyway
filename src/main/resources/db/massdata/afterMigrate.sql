...
delete from bundle;
delete from permission_bundle;
delete from permission;
delete from menu;
delete from restaurant;
delete from restaurant_paymentform;
delete from usertuyofood;
delete from usertuyofood_bundle;
...
alter sequence paymentform_id_seq RESTART WITH 1;
alter sequence bundle_id_seq RESTART WITH 1;
...
alter sequence usertuyofood_id_seq RESTART WITH 1;
...
insert into city (id, nome_city, state_id) values (1, 'Uberlândia', 1);
insert into city (id, nome_city, state_id) values (2, 'Belo Horizonte', 1);
insert into city (id, nome_city, state_id) values (3, 'São Paulo', 2);
insert into city (id, nome_city, state_id) values (4, 'Campinas', 2);
insert into city (id, nome_city, state_id) values (5, 'Fortaleza', 3);
...
-- insert into restaurant (id, nome, taxa_frete, kitchen_id) values (4, 'Bologna Restaurantes', 45, 2);
 ...
 insert into paymentform (id, descricao) values (1, 'Cartão de crédito');
 insert into paymentform (id, descricao) values (2, 'Cartão de débito');
 insert into paymentform (id, descricao) values (3, 'Dinheiro');
 ...
 insert into restaurant_paymentform (restaurant_id, paymentform_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3);
